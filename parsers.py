...
def get_parser():
    ...
    parser.add_argument(
        "--reload_model_snipenc", type=str, default="", help="Reload a pretrained snip encoder for symbolic regression"
    )
    parser.add_argument(
        "--reload_model_e2edec", type=str, default="", help="Reload a pretrained e2e decoder for symbolic regression"
    )
    parser.add_argument(
